...
namespace HtmlHelpersExample.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Details(int EmpNo)
        {
            ...
            o.Name = "Vik";
            o.Basic = 12345;
            o.DeptNo = 20; //the value of IT below is 20, hence this will set the value of checkbox of IT as selected 

            List<SelectListItem> objDepts = new List<SelectListItem> //here we are generating the drop down as in Employee.cs we have passed the same collection
            {
                new SelectListItem{Text= "SALES", Value= "10"}, //its syntax consists of text and values
                new SelectListItem{Text= "IT", Value= "20"},
                new SelectListItem{Text= "HR", Value= "30"},
            };//TO DO: Read the above values from the DB using DataReader
